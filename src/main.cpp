...
const string strMessageMagic = "Nukecoinz Signed Message:\n";
...
static const int64 nBlockDigishieldStart = 5;
static const int64 nTargetTimespanDigishield = 60; // 1 min
static const int64 nTargetSpacingDigishield = 60; //1 min
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NukecoinzMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NukecoinzMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { while (true) {
        ...
        printf("Running NukecoinzMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("NukecoinzMiner terminated\n");
        throw;
    }
}
